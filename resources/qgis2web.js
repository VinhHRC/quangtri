...
map.getView().fit([11909422.240289, 1888152.127028, 11957081.789828, 1911214.966518], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Bản đồ các trận lũ lịch sử tại Quảng Trị</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (49 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Hoang Duc Vinh<br />VinhHRC@gmail.com<br />Zalo: 0906682672';
            }
